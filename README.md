...
- **Голосовые сообщения в чате** — эндпоинты для отправки голоса и получения TTS-ответа от персонажа
...
| 4.5. Голосовые сообщения (запись, STT, TTS, аудиоплеер) | ⚠️ Частично (backend API готов, frontend UI не реализован) |
