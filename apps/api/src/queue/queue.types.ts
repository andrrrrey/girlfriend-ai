...
export interface ImageJobData {
  ...
  initImageUrl?: string;
  /**
   * Публичный URL аватара персонажа как референса внешности (не img2img).
   * Задаётся для Grok-чекпоинтов: Grok не поддерживает seed, поэтому
   * внешность держится только через editImage с аватаром.
   */
