  ...
  return (
    <header className="topnav">
      ...
      <div className="topnav-buttons">
        ...
        <button className="btn-secondary">Log in <span style={{width:6,height:6,borderRadius:'50%',background:'#4ade80',display:'inline-block',marginLeft:4,boxShadow:'0 0 8px 3px rgba(74,222,128,0.6)'}}></span></button>
      </div>
    </header>
  );
}
